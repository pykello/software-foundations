...
Fixpoint bininc (n: bin) : bin :=
  match n with
  | Z => I
  | I => twice I
  | twice n' => twiceAdd1 n'
  | twiceAdd1 n' => twice (bininc n')
  end.

Example test_bininc1: (bininc Z) = I.
Proof. reflexivity. Qed.

Example test_bininc2: (bininc I) = twice I.
Proof. reflexivity. Qed.

Example test_bininc3: (bininc (twice (twice I))) = (twiceAdd1 (twice I)).
Proof. reflexivity. Qed.

Example test_bininc4: (bininc (twiceAdd1 (twiceAdd1 (twiceAdd1 I)))) = (twice (twice (twice (twice I)))).
Proof. reflexivity. Qed.

Fixpoint bin2unary (n: bin) : nat :=
  match n with
  | Z => O
  | I => S O
  | twice n' => mult (S (S 0)) (bin2unary n')
  | twiceAdd1 n' => S (mult (S (S 0)) (bin2unary n'))
  end.

Example test_bin2unary1: (bin2unary Z) = O.
Proof. reflexivity. Qed.

Example test_bin2unary2: (bin2unary I) = S O.
Proof. reflexivity. Qed.

Example test_bin2unary3: (bin2unary (twiceAdd1 (twice (twiceAdd1 (twice I))))) = 21.
Proof. reflexivity. Qed.
...
(*Fixpoint bin2unary (n: bin) : nat :=
  ...
  | I => S O
  | twice n' => mult (S (S 0)) (bin2unary n')
  | twiceAdd1 n' => S (bin2unary (twice n'))
  end.*)
(** [] *)
